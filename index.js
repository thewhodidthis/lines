 ...
 */
const poly = (radius = 0, sides = 3) => {
  // Theta increment, compute once
  const r = arithmetics.TAU / sides;
 ...
 */
const foxy = (radius = 0, m1 = 0, n1, n2, n3, a = 1, b = a, m2 = m1) => {
  const { cos, pow, abs } = Math;

  const input = [a, b, m1, m2, n2, n3];
  const shift = arithmetics.TAU * 0.25;
